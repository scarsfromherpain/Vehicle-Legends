...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/scarsfromherpain/Vehicle-Legends/main/library.lua"))()
...
local car =game:GetService("Workspace").Vehicles[game.Players.LocalPlayer.Name.."'s Car"]
local TweenService = game:GetService("TweenService")
local TweenInfoToUse = TweenInfo.new(dist/300, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, 0, false, 0)
local TweenValue = Instance.new("CFrameValue")
TweenValue.Value = car:GetPrimaryPartCFrame()        
TweenValue.Changed:Connect(function()
